            ...
            <v-row>
                <v-col>
                    <p>
                        ...
                        <span class="text-body-2">Barcelona</span>
                        <span class="text-grey ml-10 text-caption">Idioma</span>
                        <span class="text-body-2 ml-2">Português Brasileiro</span>
                    </p>
                </v-col>
                <v-col cols="auto">
                    <v-breadcrumbs density="compact" class="pt-0" divider="-" :items="items">
                        <template v-slot:item="{ item }">
                            <a class="text-caption" :href="item.href">
                                {{ item.title }}</a>
                        </template>
                    </v-breadcrumbs>
                </v-col>
            ...
            <v-row>
                <v-col class="mt-2">
                    <p class="text-caption text-grey">
                        © 2023 Amigo Local Ltd. All rights reserved.
                    </p>
                </v-col>
