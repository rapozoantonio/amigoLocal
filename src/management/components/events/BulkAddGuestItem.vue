        ...
        <td class=" text-right">
            ...
            <v-menu v-else v-model="showStatusMenu" :close-on-content-click="false" location="top">
                ...
                <v-card variant="tonal" min-width="300" v-if="existingGuests && existingGuests.length > 0">
                    ...
                    <v-list>
                        <v-list-item v-for="(existingGuest, i) in existingGuests" :key="i" prepend-icon="mdi-account"
                            :title="existingGuest.name">
                    ...
                    <v-card-actions>
                        ...
                        <v-tooltip open-delay="600" content-class="bg-green-darken-2 border" location="top">
                            ...
                            <template #activator="{ props }">
                                <v-btn color="success" v-bind="props" variant="tonal" @click="showStatusMenu = false">
                                    Vou modificar-lo
                                </v-btn>
                            </template>
                        </v-tooltip>
                ...
                <!-- EXISTING CUSTOMER -->
                <v-card variant="tonal" min-width="300" v-else-if="existingCustomers && existingCustomers.length > 0">
                    <v-card-title class="d-flex justify-space-between align-center">
                    ...
                    <v-list v-model:selected="selectedExistingCustomer">
                        ...
                        <v-list-item v-for="(existingCustomer, i) in existingCustomers" :key="i"
                            ...
                            <template v-slot:subtitle>
                                ...
                                <span class="mr-2" v-if="existingCustomer.instagram"><v-icon>mdi-instagram</v-icon>{{
