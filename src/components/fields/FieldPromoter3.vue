<template>
    <div>
        <v-autocomplete v-if="promoters" v-bind="{ ...fieldAttrs, ...$attrs }" v-model="promoter" :items="promoters"
            ...
            <template #prepend-item>
                ...
                <!-- <div class="text-center">
                                    <v-btn variant="plain">Add Promoter</v-btn>
                                </div> -->
            </template>
        ...
        <form-dialog v-model:opened="dialog" v-if="newPromoter" @submit="createAndAssociate"
            action="Create and Associate" :schema="promoterSchema" v-model:model="newPromoter" labelType="in"
