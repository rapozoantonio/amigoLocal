    ...
    <v-bottom-sheet v-model="opened">
        <template v-slot:activator="{ props }">
            <div class="text-center">
                <v-btn :block="block" v-bind="props" color="primary" :size="size" :text="action"
...
const { variant, size, action, title, text, block } = defineProps({
    ...
    size: {
        type: [String, null], default: "small"
    },
    action: {
        type: String, default: "Virtual Assistent"
    },
    title: {
        type: String, default: "Virtual Assistente"
    },
    text: {
        type: String, default: "Cole o texto de divulgação e deixe que nossa assistente virtual te ajude a preencher os dados do evento"
    },
    block: {
