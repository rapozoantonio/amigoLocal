<template>
    <section>
        ...
        <v-container>
            ...
            <v-row v-else>
                <v-col md="6" cols="12">
                    <form-box :dense="false" @submit="submitRegister" :schema="registrationSchema" action="Registrar"
                        title="Novo usuario" labelType="up" v-model:model="user">
                    </form-box>
                </v-col>
                <v-col v-if="false" md="8" cols="12">
                    <v-card color="transparent" max-width="600" flat>
                        ...
                        <v-card-subtitle class="text-h5 mt-5">Informações de Login</v-card-subtitle>
                        <v-card-text>
                            <v-row dense>
                                <v-col cols="12" sm="6" class="mb-2">
                                    <!-- <label class="text-caption required" for="name">Name</label> -->
                                    <v-text-field id="name" name="name" variant="outlined" rounded="pill" label="Name *"
                                        hide-details="auto" density="compact" class="mb-2" v-model="user.name" required
                                ...
                                <v-col cols="12" sm="6" class="mb-2">
                                    ...
                                    <v-text-field id="email" name="email" type="email" variant="outlined"
                                        hide-details="auto" label="Email *" rounded="pill" density="compact"
                                        class="mb-2" v-model="user.email" :rules="[rules.required]"></v-text-field>
                                </v-col>
                                <v-col cols="12" sm="6" class="mb-2">
                                    ...
                                    <v-text-field id="password" name="password" :type="showPassword
                                        ...
                                        hide-details="auto" label="Password *" :append-inner-icon="showPassword
                                            ? 'mdi-eye'
                                            : 'mdi-eye-off'
                                            " @click:append-inner="
                        ...
                        <!-- MARKETING CONSENT -->
                        <v-card-subtitle class="text-h5 mt-5">Junte-se a comunidade
                        </v-card-subtitle>
                        <v-card-text>
                            <p>
                ...
                <v-spacer></v-spacer>
                <v-col cols="12" md="4">
                    <v-card color="transparent" width="300" flat position="sticky" style="top: 50px; position: sticky">
                        <v-card-text>
