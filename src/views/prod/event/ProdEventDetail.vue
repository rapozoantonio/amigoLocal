...
import FloatingActionButton from "@/components/prod/event/FloatingActionButton.vue";
import EditEventModal from "@/components/prod/event/EditEventModal.vue";
import EventDashboard from "@/components/prod/event/EventDashboard.vue";
import EventGuests from "@/components/prod/event/EventGuests.vue";
import EventLists from "@/components/prod/event/EventLists.vue";
import EventPromoters from "@/components/prod/event/EventPromoters.vue";
import EventHostesses from "@/components/prod/event/EventHostesses.vue";
import MainFourEvenMetrics from "@/components/prod/event/MainFourEvenMetrics.vue";
