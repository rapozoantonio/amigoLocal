...
import EventListItem from "@/components/prod/event/EventListItem.vue";
import FloatingActionButton from "@/components/prod/event/FloatingActionButton.vue";
import NewEventModal from "@/components/prod/event/NewEventModal.vue"; // Import the new modal component
