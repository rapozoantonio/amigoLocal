        ...
        <v-col cols="12">
          <v-stepper-vertical editable>
            <template v-slot:default="{ step }">
              ...
              >
                <v-card flat>
                  <v-card-title> Create event with ✨️AI Iris</v-card-title>
                  <v-card-text>
                    <p class="text-body-2">
                  ...
                  <v-card-text>
                    <v-row>
                      ...
                      <v-col cols="6" v-if="regions[event.location.country]">
                        <v-select
                          :items="
                            Object.entries(regions[event.location.country])
                          "
                          item-title="[1]"
                          item-value="[0]"
                          label="Region"
                        ...
                        >
                          <v-col cols="12">
                            <v-text-field
                              ...
                              :append-icon="
                                event.links.length > 1 ? 'mdi-close' : null
                              "
