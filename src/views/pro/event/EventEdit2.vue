      ...
      <v-row>
        <v-col cols="12">
          <v-card v-if="event">
            ...
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" class="pb-0 pt-2 required">
                  <label class="text-caption required">Nome do evento</label>
                  <v-text-field
                    class="required"
                    v-bind="fieldAttrs"
                ...
                <v-col cols="8" sm="6" class="pb-0 pt-2 required">
                  <label class="text-caption required">Data início</label>
                  <v-text-field
                    v-bind="fieldAttrs"
                    type="date"
                    id="startDate"
                ...
                <v-col cols="4" sm="6" class="pb-0 pt-2">
                  <label class="text-caption">Horário início</label>
                  <v-text-field
                    v-bind="fieldAttrs"
                    type="time"
                    id="startTime"
                ...
                <v-col cols="8" sm="6" class="pb-0 pt-2">
                  <label class="text-caption">Data fim</label>
                  <v-text-field
                    v-bind="fieldAttrs"
                    type="date"
                    :min="event.startDate"
                ...
                <!-- Field event.endTime -->
                <v-col cols="4" sm="6" class="pb-0 pt-2">
                  <label class="text-caption">Horário fim</label>
                  <v-text-field
                    v-bind="fieldAttrs"
                    type="time"
                    id="endTime"
            ...
            <v-card-title> Gêneros </v-card-title>
            <v-card-text>
              <v-row>
                <v-col cols="12" class="required">
                  <label class="text-caption required">Estilos musicais</label>
                  <v-autocomplete
                    :items="genres"
                    v-bind="fieldAttrs"
                    closable-chips
                    ...
                    chips
                    item-title="name"
                    :rules="[rules.required, rules.lengthMin]"
                    id="genres"
            ...
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" md="6" class="pb-0 pt-1">
                  <label for="image" class="text-caption">Imagem</label>
                  ...
                  <v-list-item v-if="event.promoter">
                    <template #prepend>
                      <v-avatar color="primary">
                        <span>{{ event.promoter.name.charAt(0) }} </span>
                      </v-avatar>
                    </template>
                    <v-list-item-title>{{
                      event.promoter.name
            ...
            <v-card-title class="mb-4"> Imagens </v-card-title>
            <v-card-text>
              <v-row>
            ...
            <v-card-title> Visibilidade do Evento </v-card-title>
            <v-card-text>
              <v-row>
                <v-col cols="12">
                  <span class="text-caption">Visível para público</span>
                  <v-switch
                    variant="outlined"
                    density="compact"
                    rounded="pill"
