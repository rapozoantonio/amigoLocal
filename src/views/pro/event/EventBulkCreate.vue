              ...
              <v-card-text>
                <v-row>
                  <v-col cols="12" class="pb-0">
                    ...
                    <v-text-field
                      v-bind="helpers.fieldAttrs"
                      v-model="events[selection.index].name"
                    ></v-text-field>
                  </v-col>
                  <v-col cols="12" class="pb-0">
                    ...
                    <v-text-field
                      type="date"
                      v-bind="helpers.fieldAttrs"
                      v-model="events[selection.index].startDate"
                    ></v-text-field>
                  </v-col>
                  <v-col cols="12" class="pb-0">
                    ...
                    <v-textarea
                      v-bind="helpers.fieldAttrs"
                      rows="1"
                      v-model="events[selection.index].description"
                    ></v-textarea>
                  </v-col>
                  <template
                    v-for="(link, i) in events[selection.index].links"
                    :key="link.url"
                  >
                    <v-col cols="12">
